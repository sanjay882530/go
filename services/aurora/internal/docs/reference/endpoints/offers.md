---
title: Offers
replacement: https://developers.hcnet.org/api/resources/offers/list/
---
...
```sh
curl "https://aurora-testnet.hcnet.org/offers{?selling_asset_type,selling_asset_issuer,selling_asset_code,buying_asset_type,buying_asset_issuer,buying_asset_code,seller,cursor,limit,order}"
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://aurora-testnet.hcnet.org/offers?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://aurora-testnet.hcnet.org/offers?cursor=5443256&limit=10&order=asc"
    },
    "prev": {
      "href": "https://aurora-testnet.hcnet.org/offers?cursor=5443256&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
