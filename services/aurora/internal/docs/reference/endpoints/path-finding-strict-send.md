...
replacement: https://developers.hcnet.org/api/aggregations/paths/strict-send/
---
...
```
https://aurora-testnet.hcnet.org/paths/strict-send?&source_amount={sa}&source_asset_type={at}&source_asset_code={ac}&source_asset_issuer={ai}&destination_account={da}
```
...
```sh
curl "https://aurora-testnet.hcnet.org/paths/strict-send?&source_amount=10&source_asset_type=native&destination_assets=MXN:GC2GFGZ5CZCFCDJSQF3YYEAYBOS3ZREXJSPU7LUJ7JU3LP3BQNHY7YKS"
```
...
var sourceAsset = HcnetSdk.Asset.native();
var sourceAmount = "20";
var destinationAsset = new HcnetSdk.Asset(
  'USD',
