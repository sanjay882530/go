---
title: Operation
replacement: https://developers.hcnet.org/api/resources/operations/
---
...
| [PATH_PAYMENT_STRICT_RECEIVE](#path-payment)            | 2      | Sends a path payment strict receive between two accounts in the Hcnet network.                           |
| [PATH_PAYMENT_STRICT_SEND](#path-payment-strict-send)   | 13     | Sends a path payment strict send between two accounts in the Hcnet network.                              |
