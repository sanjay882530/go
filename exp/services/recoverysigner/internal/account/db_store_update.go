...
func (s *DBStore) Update(a Account) error {
	...
	// https://github.com/hcnet/go/blob/b3e0a353a901ce0babad5b4953330e55f2c674a1/exp/services/recoverysigner/internal/db/dbmigrate/migrations/20200311000002-create-auth-methods.sql#L11
