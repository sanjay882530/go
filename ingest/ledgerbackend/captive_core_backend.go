...
func (c *CaptiveHcnetCore) checkMetaPipeResult(result metaResult, ok bool) error {
	...
	// 2. The hcnet core process exited unexpectedly.
	...
	if !ok || result.err != nil {
		if result.err != nil {
			...
			return result.err
		} else if exited, err := c.hcnetCoreRunner.getProcessExitError(); exited {
			// Case 2 - The hcnet core process exited unexpectedly
			if err == nil {
